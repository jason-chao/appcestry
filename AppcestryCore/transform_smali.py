...
# This script rewrites Smali instructions to facilitate the detection of similar code.
# General principles are: 
#  Redundant instructions are removed.
#  The names for custom events and variable types are generalised.
#  Events and variable types that belong to the Android SDK are kept.
# For more details, see page 24 of http://dx.doi.org/10.13140/RG.2.2.12499.02081
...
# Template generated by ANTLR 4.7.1 for parsing Smali instructions
# The ANTLR grammar file for Smali is adapted from https://github.com/pxb1988/dex2jar/blob/2.x/d2j-smali/src/main/antlr4/com/googlecode/d2j/smali/antlr4/Smali.g4
# Modified to parse and then rewrite Smali instructions 
class SmaliTransformer(SmaliListener):
    ...
    # The rules for rewriting instructions as follows
...
def TransformMergedSmaliFile(inputFilename, outputFilename):
    """Transform Smali instructions from a file and save he results to an output file.
    Args:
      inputFilename: The full filename for the input file
      outputFilename: The full filename for the output file
     Returns:
       None
    """ 
